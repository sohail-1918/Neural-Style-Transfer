...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default="C:/Users/sohai/test2017/test2017",
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default="C:/Users/sohai/Downloads/train_3/train_3",
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default="C:/Users/sohai/Downloads/vgg_normalised.pth",
